...
public class MainController {
	...
	public BuisnessBean[] findBuisness(@RequestBody UserBean bean){
		
		double userLatitude = bean.getLatitude();
		double userLongitude = bean.getLongitude();
